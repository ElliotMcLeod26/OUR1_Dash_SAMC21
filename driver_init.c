...
void system_init(void)
{
	...
	// Set pin direction to output
	gpio_set_pin_direction(AMS_LIGHT, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(AMS_LIGHT, GPIO_PIN_FUNCTION_OFF);
	
	// GPIO on PA20

	// Set pin direction to input
	gpio_set_pin_direction(RTD_SWITCH, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(RTD_SWITCH,
	// <y> Pull configuration
	// <id> pad_pull_config
	// <GPIO_PULL_OFF"> Off
	// <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(TS_BUTTON, GPIO_PIN_FUNCTION_OFF);
	
	// Set pin direction to input
	gpio_set_pin_direction(TS_BUTTON, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(TS_BUTTON,
	// <y> Pull configuration
	// <id> pad_pull_config
	// <GPIO_PULL_OFF"> Off
	// <GPIO_PULL_UP"> Pull-up
